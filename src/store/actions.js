...
export default {
    ...
    seller_list_sort({
        ...
        return axios.post('/openservice/getSortSellerListPage', obj);
    },
    ...
    modifyPayPassApi({
        ...
        return axios.post('/innerService/ChangeThePayPassword', obj)
    },
    // 商家入驻
    merchantApi({
        commit
     ...
     */
    // 查看购物车
    getGoodsCart({ commit, state }) {
        if (state.carShopId) {
            return axios.get(`/innerService/getGoodsCart?sellerId=${state.carShopId}`)
        } else {
            return axios.get('/innerService/getGoodsCart')
        }
    },

    // 删除购物车
    deleteGoodsCart({ commit, state }) {
        if (state.cartInfo.goodsId && state.cartInfo.sellerId) {
            return axios.get(`/innerService/deleteGoodsCart?sellerId=${state.cartInfo.sellerId}&goodsId=${state.cartInfo.goodsId}`)
        } else if (state.cartInfo.sellerId) {
            return axios.get(`/innerService/deleteGoodsCart?sellerId=${state.cartInfo.sellerId}`)
        } else {
            return axios.get(`/innerService/deleteGoodsCart`)
        }
    },
    ...
    // 订单 满减与优惠
    PreferentialInformation({ commit }, obj) {
     ...
     * 通知消息
     */
    getUserMessageList ({commit}, obj) {
        return axios.post('/innerService/getUserMessageList', obj)
    },
    
    // 清空消息
    deleteUserMessage ({commit}, obj) {
