...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      saveLocation() {
        console.log("save", this.save_location.locPos);
      ...
      initialize() {
        ...
        google.maps.event.addListener(_this.map, "dragend", function (MouseEvent) {
          ...
          // console.log("dragend" + localStorage.getItem("current_city_name"));
          _this.getAdd(pos);
        });
      },
      // 搜索时展开谷歌地图位置列表
      initAutocomplete() {
        ...
        let autocomplete = new google.maps.places.Autocomplete(
          this.$refs.googleMap
          // document.getElementById("search_msg"),
          // {
          //   types: [],
        ...
        google.maps.event.addListener(autocomplete, "place_changed", function () {
          ...
          console.log("final", self.save_location.locPos);
          ...
          console.log(
            "select_address-135：",
            JSON.parse(localStorage.getItem("current_address_latlng"))
          );
          self.initialize();
        });
      }
