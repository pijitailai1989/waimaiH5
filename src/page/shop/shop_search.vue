          ...
          if(el.isSpecs==1){
             if(el.limitNum){
                if(el.number>el.limitNum){
                  let priceP=0,priceO=0;
                  priceP=( parseInt(el.number)-parseInt(el.limitNum) )*parseFloat(el.originalPrice)
                ...
                //原价
                el.total_old=Math.round( parseInt(el.number)*parseFloat(el.originalPrice) *100)/100;
             }else{
                el.total_new=Math.round( parseInt(el.number)*parseFloat(el.originalPrice)*100)/100;
                el.total_old= null;
             }
          }else{
              if(el.isDiscount==1){
