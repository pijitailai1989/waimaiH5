    ...
    <div class="src contain">
        ...
        <div class="shop_aptitude">
            ...
            <ul class="flex j-between">
                <li class="flex">
                    <i><img :src="getAptitude.industryQualificationPicPath" class="blur"/></i>
                </li>
                <li class="flex">
                    <i><img :src="getAptitude.subjectQualificationPicPath" class="blur"/></i>
                </li>
                <li class="flex" v-show="getAptitude.businessPermitsPicPath">
                    <i><img :src="getAptitude.businessPermitsPicPath" class="blur"/></i>
                </li>
            </ul>
        </div>
        <div class="shop_img">
            ...
            elem.addEventListener("click", function(e) {
              ...
              if (target.nodeName.toLowerCase() == "img") {
                if (target.parentNode.className == 'yd-slider-item') {
                  if(target.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode){
                     target.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.innerHTML = ""
                     return
                  }
                }
              } else if (target.nodeName.toLowerCase() == "div" && target.className=='yd-lightbox-img') {
...
.yd-lightbox-head>a{color:white;}
</style>