...
export default {
    ...
    mounted() {
        ...
        console.log('0000', this.userInfo.memberObj.profilePhoto)
    ...
    methods: {
        setPass() {
            this.$router.push('/set_pass/'+ this.userInfo.passwordStatus)
        },
        // setPayment() {
        //     this.$router.push('/set_payment/'+ this.userInfo.modifyThe)
        // },
        logout() {
