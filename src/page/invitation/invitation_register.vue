<template>
    <div class="invitation_register" v-show="isShow">
        ...
        <div :class="{english_bg: isActive, content_bg: !isActive}">
            <div class="inputs">
                <div class="input_bg">
                    ...
                    <div class="phone">
                        <input type="text" v-model="tel" ref="input_tel" @blur="inviteMess">
                        ...
                        <div v-if="invitDisabled && !isActive"><span class="limit">{{limitTime}}s后重新发送</span></div>
                    ...
                    <div class="phone_code">
                        ...
                        <input type="text" v-model="vCode" ref="input_code" @blur="inviteMess">
                    </div>
                </div>
                <div class="middle_btn">
                    ...
                    <div class="btn" @click="jionUs">
                        <div v-if="!isActive"><button>立即加入</button></div>
                        <div v-else><button>Join now</button></div>
                    </div>
    ...
    jionUs() {
        ...
        store
          .dispatch("invitationRegisterApi", {
            ...
            mobile: self.tel,
            mCode: self.vCode,
            certificate: self.$route.query.userID
          })
          .then(res => {
            // alert(certificate)
            if (res.data.code == 1) {
